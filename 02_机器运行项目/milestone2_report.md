...
![01_NAV](C:/Users/huangwq01/Desktop/期权策略/outputs/milestone2/20260827_140345_stop/charts/01_NAV.png)

OTM曲线只保留可复算部分，之后为空，不作连线、延长或收益外推。完整共同区间的横向比较尚未完成。

![02_drawdown](C:/Users/huangwq01/Desktop/期权策略/outputs/milestone2/20260827_140345_stop/charts/02_drawdown.png)

回撤图只比较已完成相同日期区间的Delta和基准。净值含期权结算价盯市，不是按每日清算可实现的价格。

## 4. 收益月份、年份与超额路径

![03_monthly_returns](C:/Users/huangwq01/Desktop/期权策略/outputs/milestone2/20260827_140345_stop/charts/03_monthly_returns.png)

2017—2020年大部分时段没有实际卖Call；月度收益中的这部分主要来自ETF。没有把缺失期权信号日排出统计样本。

![04_annual_returns](C:/Users/huangwq01/Desktop/期权策略/outputs/milestone2/20260827_140345_stop/charts/04_annual_returns.png)

首尾年度为不完整年度，不能拿其收益率直接与完整年度比较；两条序列的实际日期窗一致。

![05_excess_return](C:/Users/huangwq01/Desktop/期权策略/outputs/milestone2/20260827_140345_stop/charts/05_excess_return.png)
...
![08_option_pnl](C:/Users/huangwq01/Desktop/期权策略/outputs/milestone2/20260827_140345_stop/charts/08_option_pnl.png)

图中同时计入未平仓盯市。每笔已实现损益通过 `entry_trade_id` 关联开、平仓交易，避免将累计毛权利金直接当作期权收益。

## 6. 入场属性与公司行动

![06_entry_moneyness](C:/Users/huangwq01/Desktop/期权策略/outputs/milestone2/20260827_140345_stop/charts/06_entry_moneyness.png)

![07_entry_delta](C:/Users/huangwq01/Desktop/期权策略/outputs/milestone2/20260827_140345_stop/charts/07_entry_delta.png)
...
标准数据位于 `data_mart/`；本次所有CSV/JSON、独立对账和图表位于 `C:/Users/huangwq01/Desktop/期权策略/outputs/milestone2/20260827_140345_stop`。每次运行保留独立run_id及完整参数。数据manifest包含日期范围、增量策略与标准文件SHA256校验，读取时拒绝不完整或被改写的快照。
